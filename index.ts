...
class Customer{
    ...
    getcustomerinfo(){
        return `
               First Name: ${chalk.bold.rgb(255,  218, 185).italic(this.firstName)} -
               Last Name: ${chalk.bold.rgb(255,  218, 185).italic(this.lastName)} - 
               Age: ${chalk.bold.rgb(255,  218, 185).italic(this.age)} - 
               Gender: ${chalk.bold.rgb(255,  218, 185).italic(this.gender)} - 
               Mobile Number: ${chalk.bold.rgb(255,  218, 185).italic(this.mobileNumber)} - 
